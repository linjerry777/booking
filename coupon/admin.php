            ...
            <div class="topbar">
                ...
                <div class="search">
                    <form action="admin.php" method="get">
                        <label>
                            <input type="text" placeholder="輸入優惠券名稱後搜尋" class="form-control" name="search">
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <?php if (isset($_GET["search"])) : ?>
                            <div class="py-2">
                                <a class="btn btn-info" href="admin.php">回優惠券列表</a>
                            </div>
                            <h1><?= $_GET["search"] ?> 的搜尋結果</h1>
                        <?php endif; ?>

                        <div class="py-2 d-flex justify-content-end">
                            <a class="btn btn-info" href="admin-add-coupon.php">新增優惠券</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php foreach ($rows as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="admin-edit-coupon.php?id=<?= $row["id"] ?>">編輯</a>
