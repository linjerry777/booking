            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <?php if ($hotelAccounCount <= 0) : ?>
                                <?= "使用者不存在" ?>
                            <?php else : ?>
                                <tr>
                                    <td>公司名</td>
                                    <td><?= $hotelAccountRow["company_name"] ?></td>
                                </tr>
                                <tr>
                                    <td>負責人</td>
                                    <td><?= $hotelAccountRow["name"] ?></td>
                                </tr>
                                <tr>
                                    <td>聯絡電話</td>
                                    <td><?= $hotelAccountRow["company_phone"] ?></td>
                                </tr>
                                <tr>
                                    <td>星級</td>
                                    <td>
                                        <?php for ($i = 0; $i < $hotelAccountRow["stars"]; $i++) : ?>
                                ...
                                <tr>
                                    <td>開業日期</td>
                                    <td><?= $hotelAccountRow["start_date"] ?></td>
                                </tr>
                                <tr>
                                    <td>官網</td>
                                    <td><?= $hotelAccountRow["website"] ?></td>
                                </tr>
                                <tr>
                                    <td>電子信箱</td>
                                    <td><?= $hotelAccountRow["email"] ?></td>
                                </tr>
                                <tr>
                                    <td>服務項目</td>
                                    <td>
                                        <?php foreach ($hotelServiceRow as $service => $serviceOfHotel) : ?>
                                            <?php if ($serviceOfHotel == 1 && $service !== "id") : ?>
                                                <span class="btn btn-info m-1"><?= $service ?></span>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </td>
                                </tr>
                    ...
                    <div class="py-2">
                        <a class="btn btn-info" href="hotel-account-edit.php">編輯使用者</a>
                    </div>
