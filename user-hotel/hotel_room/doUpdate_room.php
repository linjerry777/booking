...
if ($_FILES["picture"]["name"] == "") {
    ...
    $sqlRoomService = "UPDATE room_service_list SET room='$roomType', pet='$pet', tv='$tv', tub='$tub', meal='$meal', mini_bar='$miniBar', window='$window', corner='$corner', valid=1 WHERE room='$roomType'";
