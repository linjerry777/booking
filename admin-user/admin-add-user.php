    ...
    <div class="crud-container">
        ...
        <div class="main">
            ...
            <div class="cardBox">
                ...
                <div class="card">
                    <div>
                        <div class="numbers"><?= $aveageAge ?></div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers"><?= $maleCount ?>:<?= $femaleCount ?></div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers"><?= $recentMembers ?>人</div>
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <form action="admin-doInsert-user.php" method="post">
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="identification">身分證</label>
